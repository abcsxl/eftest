...
{
    public partial class BlogCollectionView : XtraUserControl
    {
        public BlogCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            var fluentAPI = mvvmContext.OfType<DXEFTestApp.ViewModels.BlogCollectionViewModel>();
